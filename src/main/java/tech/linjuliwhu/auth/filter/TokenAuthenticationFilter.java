package tech.linjuliwhu.auth.filter;
...
import tech.linjuliwhu.auth.TokenAuthentication;
...
//            JSONObject data = JSON.parseObject(json);
            ...
            req.setAttribute("tech.linjuliwhu.auth.filter.TokenAuthenticationFilter.FILTERED", true);
        }
